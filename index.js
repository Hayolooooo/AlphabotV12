...
case 'sewa':{
alpha.sendButtonText(m.chat, [{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'Menu' }, type: 1 }], `*List Harga Sewa Bot:*
...
alpha.sendButtonText(m.chat, [{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Pemilik Bot' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }], `Hallo ${pushname}
...
case 'listprem': 
alpha.sendContact(m.chat, global.kasua, m)
break
...
case 'botgrup':
case 'botgroup': {
reply (`Hallo *${pushname}*, Jangan Lupa Ramein Ya🤗
Nih Link Grup Nya:
https://chat.whatsapp.com/GAuAnrTrjLlKhAUPoS5xM2`)
}
break
...
alpha.sendButtonText(m.chat, [{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Pemilik Bot' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }], `*Runtime :* ${runtime(process.uptime())}`, `ᴹᴿ᭄ Arulོ ×፝֟͜×`, fgif)
}
break 
