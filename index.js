...
alpha.sendButtonText(m.chat, [{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Pemilik Bot' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }], `${runtime(process.uptime())}`, `ᴹᴿ᭄ Arulོ ×፝֟͜×`, fgif)
}
break 
