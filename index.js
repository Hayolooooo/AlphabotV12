...
case 'premium':{
alpha.sendButtonText(m.chat, [{ buttonId: 'cmdpembayaran', buttonText: { displayText: 'Buy Premium' }, type: 1 },{ buttonId: 'cmdharga', buttonText: { displayText: 'List Harga' }, type: 1 }], `*Berikut Command Yang Dapat Digunakan Oleh User Premium/VIP:*
...
case 'cmdharga':{
alpha.sendButtonText(m.chat, [{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }], `*Arul Bot*
...
"id": 'command'
        ...
        await alpha.send5ButImg(from, lang.prem(ownernomer) , `© ${ownername}`,qris, but , { userJid: m.chat, quoted: m })
    }
 break 
