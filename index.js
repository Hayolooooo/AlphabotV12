...
const { aiovideodl } = require('./lib/yaoi.js')
...
alpha.sendMessage(from, buttonMessage, {quoted:m})
} else {
m.reply("Link Error!")
}
}
...
case 'sewa':
 case 'sewabot': {
alpha.sendButtonText(m.chat, [{ buttonId: 'pketentuan', buttonText: { displayText: 'Aturan Sewa Bot' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'Back To Menu' }, type: 1 }], `*ArulBot*
...
case 'pketentuan': {
alpha.sendButtonText(m.chat, [{ buttonId: 'pawokawok', buttonText: { displayText: 'Lanjutkan Pembayaran' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'Back' }, type: 1 }], `𝑲𝒆𝒕𝒆𝒏𝒕𝒖𝒂𝒏 𝑺𝒆𝒘𝒂 𝑩𝒐𝒕:
...
const buttojns = [
  ...
  {buttonId: 'donasi', buttonText: {displayText: '💰 Donation'}, type: 1}
					...
					break    
	case 'allmenu':{
			await alpha.send5ButLoc(from, `Hai kak ${pushname} 👋, saya *${botname}* ` + '\n\n' + lang.listMenu(time, salam, pushname, prefix) , `${ownername}`,pp_bot, [{"urlButton": {"displayText": "TikTok","url": `${youtube}`}},{"urlButton": {"displayText": "Grup Bot","url": `${punyoden}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Rules","id": 'rules'}}] )
		}
	break   
...
case 'textprocmd': case 'textpromenu':{
 alpha.sendButImage(m.chat, sender, [{buttonId: '.command',buttonText:{displayText: '༺ Back'},type: 1},{buttonId:'owner',buttonText: {displayText:'Owner ༻'}, type: 1}], `Selamat ${salam} @${sender.split('@')[0]} 😊\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefix* :  ${prefix} \n│ *Name* : ${botname}\n│ *Owner* : @${ownernomer.split("@")[0]}\n│ *Mode* : ${alpha.public ? 'Public-Mode' : 'Self-Mode'}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n│ *Grup Bot* : ${punyoden}\n╰─⬣` + '\n\n' +  lang.textpro(prefix), `${ownername}`, [sender, ownernomer + '@s.whatsapp.net'], {quoted:m})
        ...
        break 
        case 'newupdate': {
 alpha.sendButImage(m.chat, sender, [{buttonId: '.command',buttonText:{displayText: '༺ Back'},type: 1},{buttonId:'owner',buttonText: {displayText:'Owner ༻'}, type: 1}], `Selamat ${salam} @${sender.split('@')[0]} 😊\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefix* :  ${prefix} \n│ *Name* : ${botname}\n│ *Owner* : @${ownernomer.split("@")[0]}\n│ *Mode* : ${alpha.public ? 'Public-Mode' : 'Self-Mode'}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n│ *Grup Bot* : ${punyoden}\n╰─⬣` + '\n\n' +  `╭─❒ 「 Fun Menu 」\n├ ${prefix}jadian\n├ ${prefix}jodohku\n├ ${prefix}apakah\n├ ${prefix}bagaimanakah \n├ ${prefix}bisakah\n├ ${prefix}rate\n├ ${prefix}cekganteng\n├ ${prefix}cekcantik\n├ ${prefix}ceksange\n├ ${prefix}cekgay\n├ ${prefix}ceklesbi\n├ ${prefix}cektolol\n├ ${prefix}cekpintar\n├ ${prefix}kapankah\n├ ${prefix}emojimix\n├ ${prefix}couple\n├ ${prefix}gabut\n╰❒\n`, `${ownername}`, [sender, ownernomer + '@s.whatsapp.net'], {quoted:m})
}
        break 
