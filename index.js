...
case "anjing": case "memek": case "kontol": case "bangsat": case "goblok": case "tolol": case "peler": case "pler": case "ajg": case "asw": case "asu": case "gblk": case "mmk": case "bgst": case "bngst": case "kontol": case "bego": case "anj": case "ngen": case "jancok": case "ngentot": case "titit": case "tod": case "blok": case "pea": case "haram": case "kontol": case "pepek": case "memeg": case "pepek": case "ngentot": case "pantek": case "jancok": case "jembut": case 'ngentod': case 'kntl': case 'mmq': case 'tolol': case 'kampang': case 'pentil': case 'jembot': case 'anjg':
if (isGroup) return (lang.groupOnly())
