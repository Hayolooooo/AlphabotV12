...
case 'tete': case 'tetenowm': {
                if (!text) return reply ('Masukkan Query Link!')
                reply(mess.wait)
                let anu = await fetchJson(api('zenz', '/downloader/tiktok', { url: text }, 'apikey'))
                let buttons = [
                    {buttonId: `tetewm ${text}`, buttonText: {displayText: '► With Watermark'}, type: 1},
                    {buttonId: `tetemp3 ${text}`, buttonText: {displayText: '♫ Audio'}, type: 1}
                ]
                let buttonMessage = {
            ...
            break
            case 'tetewm': case 'tetewatermark': {
                if (!text) return reply ('Masukkan Query Link!')
                reply(mess.wait)
                let anu = await fetchJson(api('zenz', '/downloader/tiktok', { url: text }, 'apikey'))
                let buttons = [
                    {buttonId: `tetenowm ${text}`, buttonText: {displayText: '► No Watermark'}, type: 1},
                    {buttonId: `tetemp3 ${text}`, buttonText: {displayText: '♫ Audio'}, type: 1}
                ]
                let buttonMessage = {
            ...
            case 'tetemp3': case 'teteaudio': {
                ...
                alpha.sendMessage(m.chat, { audio: { url: anu.result.audio }, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
...
break
  ...
  [
	{
	    title: "༺ All ༻", 
	    description: "\n_Menampilkan Semua Daftar Pelajaran_",
	    rowId: "allmapel"
  },
	{
	    title: "༺ Mapel Senin ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Senin_",
	    rowId: "msenin"
  },
    {
	    title: "༺ Mapel Selasa ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Selasa_",
	    rowId: "mselasa"
  },
    {
	    title: "༺ Mapel Rabu ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Rabu_",
	    rowId: "mrabu"
   },
     {
	    title: "༺ Mapel Kamis ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Kamis_",
	    rowId: "mkamis"
   },
     {
	    title: "༺ Mapel Jumat ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Jumat_",
	    rowId: "mjumat"
   },
     {
	    title: "༺ Mapel Sabtu ༻", 
	    description: "\n_Menampilkan Daftar Pelajaran Untuk Hari Sabtu_",
	    rowId: "msabtu"
   },
     {
	    title: "༺ Minggu ༻", 
...
/*
case 'allmapel': {
if (!isIs3) return reply (mess.tigo) 
teks = `Selamat ${salam} ${pushname} ☺
...
▣────────────⬣`
let buttons = [
{buttonId: `mapel`, buttonText: {displayText: 'Back'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://telegra.ph/file/5c6eef2d8d0457fb9f25e.jpg' },
caption: teks,
footer: "XII IS³",
buttons: buttons,
headerType: 4
