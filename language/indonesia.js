...
exports.listMapel = (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑺𝒆𝒏𝒊𝒏 」───⬣
│ ○ Bahasa Indonesia (2 jam)
│ ○ PJOK (3 jam)
│ ○ PAI (3 jam)
▣────────────⬣
...
exports.listSenin = (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑺𝒆𝒏𝒊𝒏 」───⬣
│ ○ Bahasa Indonesia (2 jam)
│ ○ PJOK (3 jam)
...
exports.listSelasa = (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑺𝒆𝒍𝒂𝒔𝒂 」───⬣
│ ○ Bahasa Indonesia (2 jam)
│ ○ Ekonomi (2 jam)
...
exports.listRabu = (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑹𝒂𝒃𝒖 」───⬣
│ ○ Sejarah P (2 jam)
│ ○ LM.Inggris (2 jam)
...
exports.listKamis = (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑲𝒂𝒎𝒊𝒔 」───⬣
│ ○ BK (2 jam)
│ ○ Matematika (2 jam)
...
exports.listJumat= (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑱𝒖𝒎𝒂𝒕 」───⬣
│ ○ Geografi (2 jam)
│ ○ Sosiologi (2 jam)
...
exports.listSabtu= (time, salam, pushname, prefix) => {
    return `
⃝▣──「 𝑴𝒂𝒑𝒆𝒍 𝑺𝒂𝒃𝒕𝒖 」───⬣
│ ○ Sejarah P (2 jam)
│ ○ LM.Inggris (2 jam)
...
╭─❒ 「 Download 」 
├ ${prefix}tiktok *<emror>*
├ ${prefix}tiktoknowm *<emror>*
├ ${prefix}tiktokwm *<emror>*
├ ${prefix}tiktokaudio *<emror>*
├ ${prefix}ytdl [link]
├ ${prefix}play [query]
├ ${prefix}ytmp3 [link]
...
➡️ Script ini bisa kalian dapatkan dari owner ArulBot 
...
*Script :* nekopoi.care
*Github :* https://github.com/Arulllllllllllll
*Rest Api :* https://rest-api-arulbot.herokuapp.com
`
}
